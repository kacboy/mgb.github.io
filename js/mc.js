...
$.getJSON(url, function (r) {
  ...
  $('#rest').html('<b>SERVER ONLINE!</b><br>Message me to be whitelisted.<br>Open to Java and Bedrock players.<br>Use port 19132 for Bedrock Edition.<br><br><p>Discord: <a href="https://discord.gg/5mztRFs">https://discord.gg/5mztRFs</a></p><br><b>MOTD:</b> ' + r.description.replace(/§(.+?)/gi, '') + '<br><b>Version:</b> ' + r.version.name + '<br><br><b>Players Online:</b> ' + r.players.online + '/' + r.players.max + '<br><ul>' + pl + '</ul>');

  $('#server-icon-img').attr('src', r.favicon);
